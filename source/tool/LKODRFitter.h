...
#ifndef LKODRFITTER_HH
#define LKODRFITTER_HH
...
class LKODRFitter
{
  ...
  private:
    ...
    Double_t fXCentroid; ///< x-Centroid position of the point set
    Double_t fYCentroid; ///< y-Centroid position of the point set
    Double_t fZCentroid; ///< z-Centroid position of the point set
  ...
  private:
    static LKODRFitter *fInstance;

  ClassDef(LKODRFitter, 1);
};
