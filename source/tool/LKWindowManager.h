...
#define lk_cvs(name)    LKWindowManager::GetWindowManager() -> Canvas(name)
...
#define lk_cvs_r(name,width0,height0)  LKWindowManager::GetWindowManager() -> CanvasResize(name, width0, height0);
