#ifndef LKPOLYGONPADPLANE_HH
#define LKPOLYGONPADPLANE_HH

#include "LKEvePlane.h"
#include "LKPad.h"
#include "TPad.h"

class LKPolygonPadPlane : public LKEvePlane
{
    public:
        LKPolygonPadPlane();
        LKPolygonPadPlane(const char *name, const char *title);
        virtual ~LKPolygonPadPlane() {};
