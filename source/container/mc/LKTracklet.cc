...
TGraph *LKTracklet::TrajectoryOnPlane(kbaxis_t axis1, kbaxis_t axis2, Double_t scale)
{
...
TGraph *LKTracklet::TrajectoryOnPlane(kbaxis_t axis1, kbaxis_t axis2, bool (*fisout)(TVector3 pos), Double_t scale)
{
  if (fTrajectoryOnPlane == nullptr) {
    fTrajectoryOnPlane = new TGraph();
    fTrajectoryOnPlane -> SetLineColor(kRed);
